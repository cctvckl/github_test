...
/**
 * 改造自JsonEncoder,把Object序列化为lua对象
 * 
...
public class LuaEncoder {
     ...
     * 为什么需要这个实例对象？
     */
    private static final LuaEncoder encoder = new LuaEncoder();
    /**
     * 16进制的字符数组
     */
    ...
    protected void printBean(Object object, StringBuilder out) throws IOException {
        ...
        try {
            ...
            // TODO:支持public字段,但没get方法的输出.
            // TODO:实现方法,通过Class.getFields获取所有的Public属性,然后放入map,先用内省获得get方法,排除map已输出的属性
            // TODO:最后遍历剩下的public属性输出.
            // TODO:以后有这个需求再加这个功能,用着先~~
    ...
    protected void print(Map<?, ?> map, StringBuilder out) throws IOException {
        ...
        for (Map.Entry<?, ?> e : map.entrySet()) {
            ...
            out.append(e.getKey());// lua的key不需要双引号
            out.append('=');
